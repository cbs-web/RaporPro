...
if not exist "%PYTHON_EXE%" set "PYTHON_EXE=%LocalAppData%\Programs\Python\Python314\python.exe"
...
if errorlevel 1 (
    echo.
    echo RaporPro baslatilamadi. Detay icin logs\error.log dosyasina bakin.
